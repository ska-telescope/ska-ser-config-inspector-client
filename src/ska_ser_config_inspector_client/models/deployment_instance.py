...
class DeploymentInstance(BaseModel):
    ...
    phase: StrictStr
    __properties: ClassVar[List[str]] = ["resource_type", "phase"]

    @field_validator('resource_type')
    def resource_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Deployment', 'Statefulset']):
            raise ValueError("must be one of enum values ('Deployment', 'Statefulset')")
        return value
