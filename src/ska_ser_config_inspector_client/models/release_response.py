...
class ReleaseResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chart", "version", "sub_charts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_charts (list)
        _items = []
        if self.sub_charts:
            for _item in self.sub_charts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['sub_charts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sub_charts": [ChartSummary.from_dict(_item) for _item in obj["sub_charts"]] if obj.get("sub_charts") is not None else None
        })
        return _obj
